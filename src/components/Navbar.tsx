    ...
    <nav className="cs-nav" aria-label="Navigation principale">
      <div className="cs-lang-switcher">
        <button
          ...
          className={language === "fr" ? "cs-lang-btn active" : "cs-lang-btn"}
        >
          FR
        </button>
        ...
        <button
          ...
          className={language === "en" ? "cs-lang-btn active" : "cs-lang-btn"}
        >
          EN
        </button>
        <img
      ...
      <div className="cs-nav-right">
        ...
        <button
          onClick={() => navigate("/")}
          className={isHome ? "cs-nav-link active" : "cs-nav-link"}
        >
        ...
        <button
          ...
          className={isContact ? "cs-nav-link active" : "cs-nav-link"}
        >
          Contact
        </button>
      </div>
